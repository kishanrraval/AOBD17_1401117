...
- The PPCA was implemented on iris data.
- The EM was implemented by generating the random samples of data. The algorithm is iterative and generates output on every iteration. 
